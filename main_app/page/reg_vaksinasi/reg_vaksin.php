						...
						<body>
							...
							<tr>
								...
								<td class="center" width="130px">
									...
									<span>
										<a href="main_app.php?page=pindah_reg_vaksin&id=<?= urlencode($row['no_rawat']); ?>"><button class="btn btn-outline-secondary btn-sm" style="width: 40px"><img src='../assets/assets-admin/img/icons/pindah.png'></button></a>
									</span>
								</td>
							</tr>
							<?php
